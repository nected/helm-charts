...
*/}}
{{- define "vidhaan-executer.fullname" -}}
...
Common labels
*/}}
{{- define "vidhaan-executer.labels" -}}
helm.sh/chart: {{ include "vidhaan-executer.chart" . }}
{{ include "vidhaan-executer.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "vidhaan-executer.selectorLabels" -}}
app.kubernetes.io/name: {{ include "vidhaan-executer.name" . }}
...
*/}}
{{- define "vidhaan-executer.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "vidhaan-executer.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
*/}}
{{- define "vidhaan-executer.podAnnotations" -}}
...
*/}}
{{- define "vidhaan-executer.autoSetupPodAnnotations" -}}
{{- if .Values.autoSetup.enabled }}
{{- include "vidhaan-executer.podAnnotations" . }}
...
*/}}
{{- define "vidhaan-executer.autoSetupPodAnnotationsHook" -}}
{{- include "vidhaan-executer.podAnnotations" . }}
{{- if .Values.autoSetup.enabled }}
{{- include "vidhaan-executer.autoSetupPodAnnotations" . }}
...
{{/*
Create vidhaan-executer default configmap from values.config
*/}}
{{- define "vidhaan-executer.staticConfig" -}}
SERVER_HOST: "0.0.0.0"
SERVER_PORT: "8001"
...
ELASTIC_ENTITY_AUDIT_INDEX: audit-log-vidhaan-executer
...
{{/*
Create vidhaan-executer configmap from values.envVars
*/}}
{{- define "vidhaan-executer.defaultConfig" -}}
{{- with .Values.envVars }}
{{- toYaml . }}
{{- end }}
{{- end }}
...
{{/*
Create vidhaan-executer configmap from Values.vidhaan-executer.defaultConfig
*/}}
{{- define "inherited.defaultConfig" -}}
{{- if .Values.vidhaan-executer }}
{{- $_ := set .Values "envVars" .Values.vidhaan-executer.envVars }}
{{- end }}
{{- end }}
