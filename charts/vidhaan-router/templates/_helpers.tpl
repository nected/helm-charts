...
*/}}
{{- define "vidhaan-router.fullname" -}}
...
Common labels
*/}}
{{- define "vidhaan-router.labels" -}}
helm.sh/chart: {{ include "vidhaan-router.chart" . }}
{{ include "vidhaan-router.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "vidhaan-router.selectorLabels" -}}
app.kubernetes.io/name: {{ include "vidhaan-router.name" . }}
...
*/}}
{{- define "vidhaan-router.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "vidhaan-router.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
*/}}
{{- define "vidhaan-router.podAnnotations" -}}
...
*/}}
{{- define "vidhaan-router.autoSetupPodAnnotations" -}}
{{- if .Values.autoSetup.enabled }}
{{- include "vidhaan-router.podAnnotations" . }}
...
*/}}
{{- define "vidhaan-router.autoSetupPodAnnotationsHook" -}}
{{- include "vidhaan-router.podAnnotations" . }}
{{- if .Values.autoSetup.enabled }}
{{- include "vidhaan-router.autoSetupPodAnnotations" . }}
...
{{/*
Create vidhaan-router default configmap from values.config
*/}}
{{- define "vidhaan-router.staticConfig" -}}
SERVER_HOST: "0.0.0.0"
SERVER_PORT: "8001"
...
ELASTIC_ENTITY_AUDIT_INDEX: audit-log-vidhaan-router
...
{{/*
Create vidhaan-router configmap from values.envVars
*/}}
{{- define "vidhaan-router.defaultConfig" -}}
{{- with .Values.envVars }}
{{- toYaml . }}
{{- end }}
{{- end }}
...
{{/*
Create vidhaan-router configmap from Values.vidhaan-router.defaultConfig
*/}}
{{- define "inherited.defaultConfig" -}}
{{- if .Values.vidhaan-router }}
{{- $_ := set .Values "envVars" .Values.vidhaan-router.envVars }}
{{- end }}
{{- end }}
